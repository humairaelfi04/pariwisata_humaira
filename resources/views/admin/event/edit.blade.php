            ...
            <div class="card-header bg-transparent border-0 px-4 py-3">
                <div class="d-flex justify-content-between align-items-center">
                    <h4 class="fw-bold mb-0" style="color: #8B4513;">
                        <i class="bi bi-calendar-edit me-2" style="color: #CD853F;"></i> Edit Event
                    </h4>
                ...
                <form action="{{ route('admin.event.update', $event->id) }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" name="tanggal_berakhir" id="tanggal_berakhir" class="form-control rounded-3" value="{{ old('tanggal_berakhir', $event->tanggal_berakhir) }}"
                                   style="border: 2px solid #DEB887; background: rgba(255, 255, 255, 0.8); transition: all 0.3s ease;">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="penyelenggara" id="penyelenggara" class="form-control rounded-3" value="{{ old('penyelenggara', $event->penyelenggara) }}"
                                   style="border: 2px solid #DEB887; background: rgba(255, 255, 255, 0.8); transition: all 0.3s ease;"
...
.img-thumbnail:hover {
    ...
    box-shadow: 0 8px 20px rgba(139, 69, 19, 0.2) !important;
}
