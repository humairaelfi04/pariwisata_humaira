                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <select name="jenis_kategori" id="jenis_kategori" class="form-select rounded-end" required
                                ...
                                <option value="umkm" {{ old('jenis_kategori', $category->jenis_kategori) == 'umkm' ? 'selected' : '' }}>
                                    UMKM
                                </option>
                                <option value="acara" {{ old('jenis_kategori', $category->jenis_kategori) == 'acara' ? 'selected' : '' }}>
                                    Acara/Event
                                </option>
                            </select>
                        </div>
